...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/ascii-hi4-dark (2).gif">
  <img src="assets/ascii-hi4-light (2).gif" alt="Rafael Ibayev ASCII portrait" width="840">
</picture>
