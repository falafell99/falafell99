...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/ascii-hi4-dark (4).gif">
  <img src="assets/ascii-hi4-light (4).gif" alt="Rafael Ibayev ASCII portrait" width="840">
</picture>
