...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/ascii-hi4-dark (5).gif">
  <img src="assets/ascii-hi4-light (5).gif" alt="Rafael Ibayev ASCII portrait" width="840">
</picture>
