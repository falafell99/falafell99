...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/ascii-hi4-dark (3).gif">
  <img src="assets/ascii-hi4-light (3).gif" alt="Rafael Ibayev ASCII portrait" width="840">
</picture>
